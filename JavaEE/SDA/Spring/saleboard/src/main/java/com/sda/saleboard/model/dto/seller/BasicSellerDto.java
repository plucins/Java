...
public class BasicSellerDto {
    ...
    public BasicSellerDto(Long id, String email, String firstName, String lastName) {
        this.id = id;
        this.email = email;
    ...
    public static BasicSellerDto create(Seller seller){
        return new BasicSellerDto(seller.getId(),seller.getEmail(),seller.getFirstName(),seller.getLastName());
    }
}
