        ...
        <table border="0">
            ...
            <c:forEach var="category" items="${categories}">
                <tr> <!-- Map<Integer, Category> -->
                    ...
                    <td>
                        <a href="<c:url value="../category.jsp"><c:param name="id" value="${category.id}" /><c:param name="view" value="edit_form"/></c:url>">edytuj</a>
                        <a href="<c:url value="/modifyCategory"><c:param name="id" value="${category.id}" /><c:param name="action" value="remove"/></c:url>">usuń</a>
                    </td>
                </tr>
            </c:forEach>
        </table>
